...
Using JavaScript fetch to GET data from a public API.
...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/MRBlach/dog-api/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/MRBlach/dog-api/issues/new). Please include sample queries and their corresponding results.
...
+ Thanks to **BootSwatch** for supporting us with a [free BootStrap theme](https://bootswatch.com/)
+ Thanks to **Dog.CEO** for providing the [free API for open source dog photos](https://dog.ceo/dog-api/)

### You may also like..

+ [Cat Fact API](https://github.com/MRBlach/cat-fact-api "Cat Fact API") - Example of API fetch for cat facts
